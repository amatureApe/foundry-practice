...
contract ForkTest2 is Test {
    ...
    function testCreateContract() public {
        ...
        // after switching to another contract we still know `address(simple)`
        // but the contract only lives in `mainnetFork`
    ...
    function testCreatePersistentContract() public {
        ...
        // This will succeed because the contract is now also available on the `optimsimFork`
        assertEq(simple.value(), 100);
    }
}
